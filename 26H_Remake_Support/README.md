...
- 已有的 **best.pt** 保存在 **Data/Training/Models/**，與樹莓派正式運行的 **26H_Remake_Raspderry/assets/models/hailo/best.hef** 分開。NCNN 只在需要驗證該後端時才導出。
